...
open class TalkativeButton(x: Int, y: Int, width: Int, height: Int, message: Component = Component.literal("Button"), private val onPress: Button.OnPress, private val onTooltip: OnTooltip = NO_TOOLTIP) : Button(x, y, width, height, message, onPress, onTooltip) {
